        ...
        <div class="container pt-10 pt-md-14 pb-14 pb-md-16 text-center">
            <div class="row gx-lg-8 gx-xl-12 gy-10 gy-xl-0 mb-14 align-items-center">
                <div class="col-lg-6 order-lg-2">
                    <figure><img class="img-auto" style="width: 500px;"
                            src="https://res.cloudinary.com/diptxmzhz/image/upload/v1681588178/Rawan%20Kecelakaan/35043_pqgm7h.jpg"
                            alt="" /></figure>
                </div>
                <!-- /column -->
                <div class="col-md-10 offset-md-1 offset-lg-0 col-lg-6 text-center text-lg-start">
                    ...
                    <h1 class="fs-54 mx-lg-0" style="margin-top: -20px;"><span class="rotator-fade text-primary"
                            style="text-align: justify;"> Bijak, Aman, Tertib</span></h1>
            ...
            <div class="row d-flex align-items-center justify-content-center">
                <div class="col-lg-8 mt-lg-2">
                    <div class="row align-items-center counter-wrapper gy-6 text-center">
                        <div class="col-md-4">
                            <div class="icon btn btn-circle btn-lg btn-soft-primary pe-none mb-4"> <i
            ...
            <div class="row gx-lg-8 gx-xl-12 gy-11 px-xxl-5 text-center d-flex align-items-end">
                <div class="col-lg-3">
                    <div class="px-md-15 px-lg-3">
                        <figure class="mb-6"><img style="width: 70%;" class="img-fluid"
                                src="https://res.cloudinary.com/diptxmzhz/image/upload/v1681599273/Rawan%20Kecelakaan/Decision_fatigue-pana_1_nnfiwj.svg"
                                srcset="{{ url('assets/users/img/illustrations/i24@2x.png 2x') }}" alt="" />
                        </figure>
                ...
                <div class="col-lg-3">
                    <div class="px-md-15 px-lg-3">
                        <figure class="mb-6"><img class="img-fluid"
                                src="https://res.cloudinary.com/diptxmzhz/image/upload/v1681599434/Rawan%20Kecelakaan/Car_accesories-pana_1_vdv6lj.svg"
                                srcset="{{ url('assets/users/img/illustrations/i19@2x.png 2x') }}" alt="" />
                        </figure>
                ...
                <div class="col-lg-3">
                    <div class="px-md-15 px-lg-3">
                        <figure class="mb-6"><img style="width: 70%;" class="img-fluid"
                                src="https://res.cloudinary.com/diptxmzhz/image/upload/v1681599968/Rawan%20Kecelakaan/Winter_road-cuate_pp73so.svg"
                                srcset="{{ url('assets/users/img/illustrations/i18@2x.png 2x') }}" alt="" />
                        </figure>
                        <h3>Faktor Jalan</h3>
                ...
                <div class="col-lg-3">
                    <div class="px-md-15 px-lg-3">
                        <figure class="mb-6"><img class="img-fluid"
                                src="https://res.cloudinary.com/diptxmzhz/image/upload/v1681600192/Rawan%20Kecelakaan/Flood-bro_d0zdt6.svg"
                                srcset="{{ url('assets/users/img/illustrations/i18@2x.png 2x') }}" alt="" />
                        </figure>
    ...
    <section class="wrapper bg-gradient-reverse-primary">
        <div class="container pb-14 pb-md-16">
            <div class="row gx-lg-8 gx-xl-12 gy-10 align-items-center">
                <div class="col-lg-7">
                    <figure>
                        <iframe width="660" height="415" src="https://www.youtube.com/embed/2jxRk5nJSgg"
                        ...
                        <div class="card plain accordion-item">
                            <div class="card-header" id="headingTwo">
                                <button class="collapsed" data-bs-toggle="collapse" data-bs-target="#collapseTwo"
                                    aria-expanded="false" aria-controls="collapseTwo"> Fokus saaat berkendara</button>
                            </div>
                            <!--/.card-header -->
                        ...
                        <div class="card plain accordion-item">
                            <div class="card-header" id="headingThree">
                                <button class="collapsed" data-bs-toggle="collapse" data-bs-target="#collapseThree"
                                    aria-expanded="false" aria-controls="collapseThree"> Taati rambu lalu lintas
                                </button>
                            </div>
                            <!--/.card-header -->
                        ...
                        <div class="card accordion-item shadow-lg">
                            <div class="card-header" id="accordion-heading-3-1">
                                <button class="collapsed" data-bs-toggle="collapse"
                                    ...
                                    aria-controls="accordion-collapse-3-1">Apa itu
                                    <strong>
                        ...
                        <div class="card accordion-item shadow-lg">
                            <div class="card-header" id="accordion-heading-3-2">
                                <button class="collapsed" data-bs-toggle="collapse"
                                    ...
                                    aria-controls="accordion-collapse-3-2">Data yang di gunakan dalam penelitian
                                    ini?</button>
                            </div>
                            <!-- /.card-header -->
                        ...
                        <div class="card accordion-item shadow-lg">
                            <div class="card-header" id="accordion-heading-3-3">
                                <button class="collapsed" data-bs-toggle="collapse"
                                    ...
                                    aria-controls="accordion-collapse-3-3">Sumber data yang digunakan pada penelitian
                                    ini?</button>
                            </div>
                            <!-- /.card-header -->
                        ...
                        <div class="card accordion-item shadow-lg">
                            <div class="card-header" id="accordion-heading-3-4">
                                <button class="collapsed" data-bs-toggle="collapse"
                                    ...
                                    aria-controls="accordion-collapse-3-4">Bagaimana jika ingin mengetahui hasil
                                    pemetaan?</button>
                            </div>
                            <!-- /.card-header -->
                            <div id="accordion-collapse-3-4" class="collapse" aria-labelledby="accordion-heading-3-4"
                                ...
                                <div class="card-body">
                                    <p>Untuk mengetahui hasil pemetaan, anda bisa klik pada menu "Pemetaan" dan anda akan di
                                        arahkan ke halaman pemetaan.Anda juga bisa menggunakan Tombol ini <a href=""
                                            type="sumbit">Pemetaan</a>
                                    </p>
                                </div>
                                <!-- /.card-body -->
                            </div>
