            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                    <div class="tab-pane show active" id="input-types-preview">
                        <div class="row">
                            <form action="{{route('rules.update', $rules->id)}}" method="post" enctype="multipart/form-data">
                                @method('PUT')
                                @csrf
                                <div class="row g-2">
                                    <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <option>{{old('kepadatan') ?? $rules->kepadatan}}</option>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="example-select" name="intensitas" required>
                                                <option>{{old('intensitas') ?? $rules->intensitas}}</option>    
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="example-select" name="kondisi_korban" required>
                                                <option>{{old('kondisi_korban') ?? $rules->kondisi_korban}}</option>
